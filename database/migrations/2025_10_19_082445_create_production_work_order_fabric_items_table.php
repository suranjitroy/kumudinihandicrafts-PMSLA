...
return new class extends Migration
{
    ...
    {
        Schema::create('production_work_order_fabric_items', function (Blueprint $table) {

            $table->id();

            $table->unsignedBigInteger('production_work_order_id');

            $table->foreign('production_work_order_id','pwo_fabric_items_fk')->references('id')->on('production_work_orders')
    ...
    {
        Schema::dropIfExists('production_work_order_fabric_items');
    }
};
