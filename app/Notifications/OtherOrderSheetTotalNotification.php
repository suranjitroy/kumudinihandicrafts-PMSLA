...
class OtherOrderSheetTotalNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        if ($this->type === 'pending') {
            ...
            'message'           => 'Other Order Submitted (Otherordersheet No: ' . $this->otherordersheet->other_order_no_t. ')',
            'requsition_no'  => $this->otherordersheet->other_order_no_t,
