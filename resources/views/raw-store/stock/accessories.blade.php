        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Accessories Stock</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Accessories Stock</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  @foreach ( $materialSetups as $materialSetup )
                    <tr>
                      ...
                      @php
                        ...
                        $sample_total = App\Models\SampleWorkOrderAccessoriesItem::where('material_setup_id', $materialSetup->id)->where('status', 1)->sum('sample_quantity');

                        $production_total = App\Models\ProductionWorkOrderAccessoriesItem::where('material_setup_id',$materialSetup->id)->where('status', 1)->sum('order_quantity');
