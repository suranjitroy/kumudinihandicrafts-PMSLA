        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Purchase Requsition</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Purchase Requsition</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="pur_requsition_date" name="requsition_date" class="form-control"
                                        value="">
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly id="pur_requsition_no" placeholder="Materialname" name="pur_requsition_no" value="{{ $purRequsitionNo }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-body"> 
                        <form method="POST" action="{{ route('purchase-requsition.store') }}" >
                            @csrf                   
...
<script id="document-template" type="text/x-handlebars-template"> 
    <tr class="delete_add_more_item" id="delete_add_more_item">
        <input type="hidden" name="pur_requsition_date" value="@{{ pur_requsition_date }}">
    ...
    $(document).ready(function(){
        ...
        var idMat = this.value;
            ...
            $.ajax({
                        ...
                        $('#unitPrice').val(material.unit_id);
