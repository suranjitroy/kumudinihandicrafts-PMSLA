        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Purchase Requsition</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Purchase Requsition List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                
                  <a href="{{ route('purchase-requsition.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Requsition</a>
                ...
                <table id="store" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $key + 1 }}</td>
                      <td>{{ $data->pur_requsition_no }}</td>
                      <td>{{ $data->pur_requsition_date}}</td>
                     ...
                     <td>
                      ...
                      <td>
                         @role('Store Staff')
                          <a href="{{ route('purchase-requsition.show', $data->id) }}" class="btn btn-info"><i class="fa fa-eye"></i>
                          </a>
                          @if($data->status == !2)
                          <a href="{{ route('purchase-requsition.edit', $data->id) }}" class="btn btn-info"><i class="fa fa-edit"></i>
                          </a>
                          <form action="{{ route('purchase-requsition.destroy', $data->id) }}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
