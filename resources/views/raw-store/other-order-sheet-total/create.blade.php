       ...
       <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                <form method="POST" action="{{ route('other-order-sheet-total.store') }}">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="entry date" id="other_order_entry_date_t" name="other_order_entry_date_t">
                  </div>
                  <div class="form-group">
                    @error('phn_no')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control" placeholder="Other order no" name="other_order_no_t" id="other_order_no_t" value="{{ $otherOrderNoTotal }}">
                  </div>
                  <div class="form-group">
                    @error('store_id')
                    <div class="alert alert-danger">{{ $message }}</div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control unit_yeard" placeholder="unit yeard" name="unit_yeard">
                  </div>
                  <div class="form-group">
                    @error('phn_no')
                         <div class="alert alert-danger">{{ $message }}</div>
