        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Store Requsition</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Store Requsition</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="requsition_date" name="requsition_date" class="form-control"
                                        value="{{ old('requsition_date', isset($purchase) ? $requsition->requsition_date ?? '' : '') }}">
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly id="requsition_no" placeholder="Materialname" name="requsition_no" value="{{ $requsitionNo }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-body"> 
                        <form method="POST" action="{{ route('store-requsition.store') }}" >
                            @csrf                   
