              ...
              <form method="POST" action="{{ route('store.store') }}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Store name" name="name">
                  </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" class="btn btn-primary toastrDefaultSuccess">Add store </button>  
                </div>
              </form>
            </div>
          </div>
                ...
                <table id="store" class="table table-bordered table-striped">
                  ...
                  @foreach ( $stores as $store )
                    <tr>
                      ...
                      <td>
                        @can('update store')
                          <a href="{{ route('store.edit', $store->id) }}" class="btn btn-info"><i class="fa fa-edit"></i>
                          </a>
                        @endcan
