...
<script id="document-template" type="text/x-handlebars-template"> 
    ...
    <tr class="delete_add_more_item" id="delete_add_more_item">
        ...
        <td>
            ...
            <input type="text" class="form-control text-right order_quantity" name="order_quantity[]" value="0">
...
<script id="document-template-ac" type="text/x-handlebars-template"> 
    <tr class="delete_add_more_item_acc" id="delete_add_more_item_acc">
        ...
        <td>
            <div class="input-group" style="width: 250px;">
            <input type="text" class="form-control text-right order_quantity_ac" name="order_quantity_ac[]" value="0">
