        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Store Requsition Edit</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Store Requsition Edit</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="requsition_date" name="requsition_date" class="form-control"
                                        value="{{ old('requsition_date', isset($requsition) ? $requsition->requsition_date ?? '' : '') }}">
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly id="requsition_no" placeholder="Materialname" name="requsition_no" value={{ $requsition->requsition_no}}>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="section_id" id="section_id">
                                    ...
                                    @foreach ( $allSection as $section)
                                        <option value="{{ $section->id }}" @if($section->id == $requsition->section_id) selected="selected" @endif>{{ $section->name }}</option>
                                    @endforeach
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-body"> 
                        <form method="POST" action="{{ route('store-requsition.update', $requsition->id) }}" >
                            @csrf
                            @method('PUT')                  
                            <table class="table-sm table-bordered" width="100%">
                                <input type="hidden" name="requsition_date" id="requsition_datee" value="{{ $requsition->requsition_date }}">
                                <input type="hidden" name="requsition_no" value="{{ $requsition->requsition_no }}">
                                <input type="hidden" name="section_id" id="section_id_edit" value="{{ $requsition->section_id }}">
                                <thead>
                                    <th>Material Name</th>
                                    <th>Quantity</th>
                                    <th>Action</th>
                                ...
                                <tbody id="addRow" class="addRow">
                                    @foreach($storerequsitionitems as $item)
...
<script id="document-template" type="text/x-handlebars-template"> 
    <tr class="delete_add_more_item" id="delete_add_more_item">
        <input type="hidden" name="requsition_date" value="@{{ requsition_date }}">
        <input type="hidden" name="requsition_no" value="@{{ requsition_no }}">
        ...
        <td>
            <div class="input-group" style="width: 250px;">
            <input type="text" class="form-control text-right quantity" name="quantity[]" value="1">
...
<script>
    $(document).ready(function(){
        $(document).on("click",".addItem", function(){
            ...
            var requsition_date   = $('#requsition_date').val();
            var requsition_no     = $('#requsition_no').val();
...
<script>
    $(document).ready(function () {
        $('#requsition_date').datetimepicker({
...
window.addEventListener('click', function () {
    var source = document.getElementById('requsition_date');
    var target = document.getElementById('requsition_datee');
