        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Sample Order</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sample Order</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly id="sample_order_no" placeholder="Materialname" name="sample_order_no" value="{{ $autoSampleOrderNo }}">
                                </div>
                            </div>
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-body"> 
                        <form method="POST" action="{{ route('sample-work-order.store') }}" >
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row" style="border:0px solid black">
                                        ...
                                        <table class="table-sm table-bordered" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <input type="text" name="grand_total_yeard" id="grand_total_yeard" class="form-control text-right grand_total_yeard" readonly style="" value="0">
                                                    </td>
                                                </tr>
                              ...
                              <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-primary toastrDefaultSuccess mt-5"> 
                                        Save 
                                    </button>
                            </div>
...
<script id="document-template-ac" type="text/x-handlebars-template"> 
    <tr class="delete_add_more_item_acc" id="delete_add_more_item_acc">
        ...
        <td>
            <div class="input-group" style="width: 250px;">
            <input type="text" class="form-control text-right sample_quantity_ac" name="sample_quantity_ac[]" value="">
