        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Sample Order</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sample Order Edit</h3>
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    value="{{ old('order_entry_date', isset($sampleOrder) ? $sampleOrder->order_entry_date ?? '' : '') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <label for="exampleInputEmail1">Sample Order No</label>
                                    <input type="text" class="form-control" readonly id="sample_order_no" placeholder="Materialname" name="sample_order_no" value={{ $sampleOrder->sample_order_no}}>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="master_info_id" id="master_info_id">
                                        ...
                                        @foreach ($allMaster as $master)
                                            ...
                                            <option value="{{ $master->id }}" @if($master->id == $sampleOrder->master_info_id) selected="selected" @endif>{{ $master->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-body"> 
                        <form method="POST" action="{{ route('sample-work-order.update', $sampleOrder->id) }}" >
                            @csrf
                            @method('PUT') 
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="text-center">Sample Order</h3>
                                </div>
                            </div>
                            <div class="row" style="border:0px solid black">
                                    <div class="col-md-8" style="border:0px solid white">
                                        ...
                                        <table class="table-sm table-bordered" width="100%">
                                            ...
                                            <input type="hidden" name="order_entry_date" id="order_entry_datee" value="{{ $sampleOrder->order_entry_date }}">
                                            <input type="hidden" name="sample_order_no" value="{{ $sampleOrder->sample_order_no }}">
                                            <input type="hidden" name="master_info_id" id="master_info_id_edit" value="{{ $sampleOrder->master_info_id }}">
                                            <input type="hidden" name="item_id" value="{{ $sampleOrder->item_id }}">
                                            <thead>
                                                <th>Item Name</th>
                                                <th>Fabric Name</th>
                                                <th>Bahar</th>
                                            ...
                                            @foreach($sampleOrderFbaricItems as $item)  
                                            <tr class="delete_add_more_item_edit" id="delete_add_more_item_edit">
                                                <input type="hidden" name="sample_order_no"  value="{{ $item->sample_order_no }}">
                                                ...
                                                <input type="hidden" name="unit_id[]" value="{{ $item->unit_id }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text" class="form-control text-right sample_quantity" name="sample_quantity[]" value="{{$item->sample_quantity}}">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    id="grand_total_quantity" class="form-control text-right grand_total_quantity" readonly style="" value="{{ $sampleOrder->grand_total_quantity }}">
                                                    </td>
                                                    <td class="text-right text-bold">Total Yeards</td>
                                                    <td>
                                                    <input type="text" name="grand_total_yeard" id="grand_total_yeard" class="form-control text-right grand_total_yeard" readonly 
                                                    style="" value="{{ $sampleOrder->grand_total_yeard }}">
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="col-md-4" style="border:0px solid white">
                                        <table class="table-sm table-bordered" width="100%">
                                            ...
                                            <tbody id="addRowAc" class="addRowAc">
                                                @foreach($sampleOrderAccItems as $item) 
                                                <tr class="delete_add_more_item_acc_edit" id="delete_add_more_item_acc_edit">
                                                    ...
                                                    <td>
                                                    <div class="input-group" style="width: 250px;">
                                                    <input type="text" class="form-control text-right sample_quantity_ac" name="sample_quantity_ac[]" value="{{ $item->sample_quantity }}">
                              ...
                              <div class="col-md-12">
                                    <div class="form-group">   
                                        ...
                                        {{-- <input type="text" class="form-control" placeholder="purpose" name="purpose" id="purpose" value="{{ $sampleOrder->purpose }}"> --}}
...
<script id="document-template" type="text/x-handlebars-template"> 
    <tr class="delete_add_more_item" id="delete_add_more_item">
        ...
        <input type="hidden" name="sample_order_no" value="@{{ sample_order_no }}">
        ...
        <td>
            <div class="input-group" style="width: 250px;">
            <input type="text" class="form-control text-right sample_quantity" name="sample_quantity[]" value="">
...
<script id="document-template-ac" type="text/x-handlebars-template"> 
    <tr class="delete_add_more_item_acc" id="delete_add_more_item_acc">
        ...
        <td>
            <div class="input-group" style="width: 250px;">
            <input type="text" class="form-control text-right sample_quantity_ac" name="sample_quantity_ac[]" value="1">
...
<script>
    $(document).ready(function(){
        $(document).on("click",".addItem", function(){
            ...
            var sample_order_no       = $('#sample_order_no').val();
        ...
        $(document).on('keyup click','.sample_quantity,.consumption_qty', function(){

            var sample_quantity = $(this).closest("tr").find("input.sample_quantity").val();
            var consumption_qty = $(this).closest("tr").find("input.consumption_qty").val();

            var total = sample_quantity * consumption_qty;
