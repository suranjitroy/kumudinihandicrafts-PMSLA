        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Embroidery Order</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Embroidery Order Entry Edit</h3>
              </div>
              <!-- /.card-header -->
                <form method="POST" action="{{ route('emb-order-sheet.update', $order->id) }}">
                ...
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Embroidery Order No" name="emb_order_no" id="emb_order_no" value="{{ $order->emb_order_no }}">
                  </div>
                  <div class="form-group">
                    @error('name')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control" placeholder="entry date" id="order_entry_date" name="order_entry_date" value="{{ $order->order_entry_date }}">
                  </div>
                  <div class="form-group">
                    @error('name')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control" placeholder="delivery date" id="order_delivery_date" name="order_delivery_date" value="{{ $order->order_delivery_date }}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="artisan_group_id" id="artisan_group_id">
                      ...
                      @foreach ( $artisanGroups as $artisanGroup)
                        <option value="{{ $artisanGroup->id }}" @if($artisanGroup->id == $order->artisan_group_id) selected="selected"  @endif>{{ $artisanGroup->group_name }}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group">
                    ...
                    @foreach ( $challans as $challan)
                      <option value="{{ $challan->id }}" @if($challan->id == $order->production_challan_id) selected="selected"  @endif>{{ $challan->pro_challan_no }}</option>
                    @endforeach
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="quantity" name="quantity" id="quantity" value="{{ $order->quantity }}">
                  </div>
                  <div class="form-group">
                    @error('phn_no')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control" placeholder="unit price" name="unit_price" id="unit_price" value="{{ $order->unit_price }}">
                  </div>
                  <div class="form-group">
                    @error('phn_no')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control total" placeholder="total" name="total" id="total" value="{{ $order->total }}">
                  </div>
                  <div class="form-group">
                    @error('phn_no')
                         <div class="alert alert-danger">{{ $message }}</div>
