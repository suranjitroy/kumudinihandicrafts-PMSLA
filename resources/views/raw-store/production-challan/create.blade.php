            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="pro_challan_date" name="pro_challan_date" class="form-control"
                                        value="{{ old('pro_challan_date', isset($purchase) ? $requsition->pro_challan_date ?? '' : '') }}">
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly id="pro_challan_no"  name="pro_challan_no" value="{{ $challanNo }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="production_work_order_id" id="proID">
                                    ...
                                    @foreach ( $workOrders as $workOrder)
                                        <option value="{{ $workOrder->id }}">{{ $workOrder->production_order_no }}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">   
                                ...
                                <input type="text" class="form-control" readonly="readonly" placeholder="Materialname" id="item_name">
                            </div>
                        </div> 
                        <div class="col-md-3">
                            <div class="form-group">   
                                <label for="exampleInputEmail1">Fabric</label>
                                <input type="text" class="form-control" readonly="readonly" placeholder="Materialname"   id="fabric_name">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">   
                                ...
                                <input type="text" class="form-control" readonly="readonly" placeholder="Materialname" id="total_quantity">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 d-none">
                            <div class="form-group">   
                                ...
                                <input type="text" class="form-control" readonly="readonly" placeholder="Materialname" id="item_id">
                            </div>
                        </div> 
                        <div class="col-md-3 d-none">
                            <div class="form-group">   
                                <label for="exampleInputEmail1">Material Setup ID</label>
                                <input type="text" class="form-control" readonly="readonly" placeholder="Materialname" id="material_setup_id">
                            </div>
                        </div> 
                        <div class="col-md-3 d-none">
                            <div class="form-group">   
                                <label for="exampleInputEmail1">Production ID</label>
                                <input type="text" class="form-control" readonly="readonly" placeholder="Materialname" id="production_work_order_id">
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-body"> 
                       <form method="POST" action="{{ route('production-challan.store') }}">
                            @csrf
                        {{-- <input type="hidden" name="item_id" id="item_id">
                        <input type="hidden" name="material_setup_id" id="material_setup_id">
                        <input type="hidden" name="production_work_order_id" id="production_work_order_id"> --}}
                                        ...
                                        <td colspan="1" class="text-right text-bold">Total Quantity</td>
                                         <td>
                                           <input type="text" name="assign_quantity_total" 
                                            id="assign_quantity_total" class="form-control text-right assign_quantity_total" readonly value="0">
                                         </td>
                                    </tr>
