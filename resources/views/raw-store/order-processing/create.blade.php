        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Production Order</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly id="production_order_no" placeholder="Materialname" name="production_order_no" value="{{ $autoProductionOrderNo }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="master_info_id" id="master_info_id">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                               <div class="form-group">
                                    ...
                                    @enderror
                                    <label>Fabirc</label>
                                    <select id="material" name="material_setup_id" class="form-control">
                            ...
                            <div class="col-md-3">
                               <div class="form-group">
                                    ...
                                    @enderror
                                    <label>Bahar</label>
                                    <select id="bahar" name="bahar_id" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                               <div class="form-group">
                                    ...
                                    <select class="form-control" id="materialAc" name="material_setup_id_ac">
                            ...
                            <div class="col-md-3">
                               <div class="form-group">
                                    ...
                                    @enderror
                                    <label>Size</label>
                                    <select class="form-control" id="sizeAc" name="size_id_ac">
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-body"> 
                        <form method="POST" action="{{ route('production-work-order.store') }}" >
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
