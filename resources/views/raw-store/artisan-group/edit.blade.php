        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Artisan Group</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
       ...
       <div class="row">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('artisan-group.update', $artisanGroup->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="group name" name="group_name" value="{{ $artisanGroup->group_name }}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Group Mobile No" name="mobile_no" value="{{ $artisanGroup->mobile_no }}">
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      @enderror
                        ...
                        <select class="form-control" name="status">
                          ...
                          <option value="0" @if($artisanGroup->status == 0) selected="selected" @endif>Active</option>
                          <option value="1" @if($artisanGroup->status == 1) selected="selected" @endif>Inactive</option>
                        </select>
                    </div>
