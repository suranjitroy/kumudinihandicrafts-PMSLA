      ...
      <div class="container-fluid">
       <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Master Information Entry</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('master-info.store') }}">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="master name" name="name">
                  </div>
                  <div class="form-group">
                    @error('phn_no')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Phone no" name="phn_no">
                  </div>
                </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary toastrDefaultSuccess">Add Master </button>  
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master Information List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
