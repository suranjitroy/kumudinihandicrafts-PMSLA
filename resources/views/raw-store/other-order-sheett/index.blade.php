        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Other Order Sheet</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Other Order List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                
                  <a href="{{ route('other-order-sheet.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Other Order</a>
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <td>
                      ...
                      <td>
                         @role('Store Staff')
                          <a href="{{ route('other-order-sheet.show', $data->id) }}" class="btn btn-info"><i class="fa fa-eye"></i>
                          </a>
                          @if($data->status == !2)
