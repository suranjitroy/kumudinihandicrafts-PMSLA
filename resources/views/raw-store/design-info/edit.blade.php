        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Design Information</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Design Information Edit</h3>
              </div>
              <!-- /.card-header -->
              <form method="POST" action="{{ route('design-info.update', $designInfo->id) }}" enctype="multipart/form-data">
                 @csrf
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <label>Entry Date </label>
                        ...
                        value="{{ old('design_entry_date', isset($designInfo) ? $designInfo->design_entry_date ?? '' : '') }}">
                  </div>
                  <div class="form-group">
                    @error('phn_no')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" readonly class="form-control" placeholder="design no" name="design_no" 
                    value="{{ $designInfo->design_no }}" >
                  </div>
                  <div class="form-group">
                    @error('name')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control" placeholder="product name" name="product_name" value="{{ $designInfo->product_name }}">
                  </div>
                  <div class="form-group">
                    @error('name')
                         <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <input type="text" class="form-control" placeholder="design name" name="design_name" value="{{ $designInfo->design_name }}">
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <select class="form-control select2" name="material_setup_id">
                      ...
                      <option value="{{ $material->id }}" @if($material->id == $designInfo->material_setup_id) selected="selected"  @endif>{{ $material->material_name }}</option>
                      @endforeach
                      </select>
                      </div>
                   {{-- <div class="form-group">
