              ...
              <form method="POST" action="{{ route('section.store') }}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="section name" name="name">
                  </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" class="btn btn-primary toastrDefaultSuccess">Add Section </button>  
                </div>
              </form>
            </div>
          </div>
                  ...
                  @foreach ( $sections as $section )
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="{{ route('section.edit', $section->id) }}" class="btn btn-info"><i class="fa fa-edit"></i>
                          </a>
