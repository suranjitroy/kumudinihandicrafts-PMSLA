              ...
              <form method="POST" action="{{ route('permission.update', $permission->id) }}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="permission name" name="name" value="{{ $permission->name }}">
                  </div>
                </div>
                <!-- /.card-body -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach ( $permissions as $permission )
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('permission.edit', $permission->id) }}" class="btn btn-info"><i class="fa fa-edit"></i></a>
